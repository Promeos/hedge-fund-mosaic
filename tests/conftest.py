...
BALANCE_SHEET_COLS = [
    ...
    "Corporate and foreign bonds; asset",
    "Total loans; asset",
    "Miscellaneous assets; asset",
    "Derivatives (long value)",
    "Total security repurchase agreements; liability",
...
def sample_balance_sheet():
    ...
    data = {
        ...
        "Security repurchase agreements; asset": [0.5, 0.6, 0.7, 0.6, 0.8],
        # Asset breakdown
        "Corporate equities; asset": [4.0, 4.5, 5.0, 4.8, 5.5],
        "Total debt securities; asset": [2.0, 2.5, 2.8, 2.7, 3.0],
        "Treasury securities; asset": [0.8, 1.0, 1.1, 1.0, 1.2],
        "Corporate and foreign bonds; asset": [1.2, 1.5, 1.7, 1.7, 1.8],
        "Total loans; asset": [1.5, 1.5, 1.5, 1.5, 1.5],
        "Miscellaneous assets; asset": [1.0, 1.1, 0.8, 0.9, 0.5],
        "Derivatives (long value)": [1.0, 1.0, 1.2, 1.0, 1.0],
        # Borrowing totals
        "Total security repurchase agreements; liability": [1.5, 1.5, 1.5, 1.5, 1.5],
