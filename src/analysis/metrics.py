...
Computes leverage ratios, asset allocation percentages, borrowing breakdowns
(prime brokerage, secured, unsecured, domestic/foreign), and growth rates
...
def compute_derived_metrics(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df["liabilities_qoq"] = df["Total liabilities"].pct_change(fill_method=None)
